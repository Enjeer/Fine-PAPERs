...
export default function ProjectsPage() {
  ...
  return (
    <div className="p-2.5 lg:p-8 max-w-6xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center justify-between mobile:pl-14">
            ...
            return (
              ...
              >
                <CardContent className="p-5 pb-7 h-full flex flex-col">
                  ...
                  <Dialog
                    open={deleteDialogOpen === p.id}
                    onOpenChange={(open) =>
                      setDeleteDialogOpen(open ? p.id : null)
                    }
                  >
                    <DialogTrigger asChild>
                      <button
